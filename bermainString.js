...
console.log('No.1 ' + word+ ' '+second+' '+third+' '+fourth+ ' '+sixth+' '+seventh);
...
console.log('No.2' + ' First Word: ' + firstWord);
...
console.log('No.3 ' + 'First Word: ' + firstWord);
console.log('Second Word: ' + secondWord);
console.log('Third Word: ' + thirdWord);
console.log('Fourth Word: ' + fourthWord);
console.log('Fifth Word: ' + fifthWord);
...
console.log('No.4 ' + 'First Word: ' + firstWord4 + ', with length: ' + firstWordLength);
